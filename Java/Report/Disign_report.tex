...
%%%%%%%%%%%%%%%%%%%include file here%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Title}
\include{Assignment_of_Responsibilities}
\include{Object_Oriented_Design}
\include{Advantage_of_Design}
\include{Disadvantage_of_Design}
\include{Packages_Utilization}
\include{How_to_Play}
